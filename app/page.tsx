...
const tilt = (e:React.MouseEvent<HTMLDivElement, MouseEvent>) => {
  ...
  const easingFactor = 0.2; // イージングの係数
...
const Home: NextPage = () => {
  return (
    <div>
      <main
        className='h-screen w-full bg-gradient-to-br from-violet-600 via-pink-500 to-orange-500 flex items-center justify-center'
        onMouseMove={tilt}
      >
        <div
          id='tiltContainer'
        ...
        >
          ...
          <div className='mt-10'>
            <input type='text' placeholder='000000000' className='bg-white/40 text-center h-max' />
          </div>
